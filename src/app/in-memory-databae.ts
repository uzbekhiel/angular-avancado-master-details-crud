...
export class InMemoryDatabase implements InMemoryDbService {
    createDb() {
        ...
        const entries: Entry[] = [
            ...
            { id: 3, name: 'Salário na empresa X', categoryId: categories[3].id, category: categories[3], paid: true, date: '15/10/2018', amount: '4405,49', type: 'reneveu' } as Entry,
            ...
            { id: 14, name: 'Pagamento pelo projeto XYZ', categoryId: categories[4].id, category: categories[4], paid: true, date: '25/10/2018', amount: '2980,00', type: 'reneveu' } as Entry,
